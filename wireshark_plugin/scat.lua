-- Plugin from scat project: https://github.com/fgsect/scat/blob/master/wireshark/scat.lua
-- Copyright (c) Shinjo Park
...
-- Custom name to avoid conflict with other versions of this plugin
local gsmtap_wrapper_proto = Proto("gsmtap_custom", "Custom analysis of the GSMTAP protocol");
